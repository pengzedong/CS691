...
<h1>Order status manage</h1>
        <div class="container-fluid"  style="border: 1px solid black; width: 90%">
            ...
            <div>
                ...
                <div class="col-sm-6"style="background-color: lavender; border: 1px solid black;">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [OrderID], [OrderTime], [OrderFood], [Waiter], [Status], concat( [OrderTime], [OrderFood], [Waiter]) as info FROM [OrderHistory] where status ='In preparation' order by orderTime"></asp:SqlDataSource>
                </div>       
        ...
        <div>
            ...
            <asp:DropDownList ID="DropDownListStatus" runat="server" AutoPostBack="True">
                ...
                <asp:ListItem Value="1">In preparation</asp:ListItem>

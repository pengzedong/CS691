<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeMall.aspx.cs" Inherits="CS691final.HomeMall" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Flavortown restaurant-Home</title>
    <meta charset="utf-8">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <%-- <div class="menu-img" style="background-image: url(images/logo02.PNG);"/> --%>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerOrderView.aspx.cs" Inherits="CS691final.CustomerOrderView" %>
                    ...
                    <form action="#" runat="server">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Label ID="lblOrderView1" runat="server" Text=" "></asp:Label>
                                <br />
                                <asp:Label ID="lblOrderView2" runat="server" Text=" "></asp:Label>
                                <br />
                                <asp:Label ID="lblOrderView3" runat="server" Text=" "></asp:Label>
                                <br />
                                <asp:Label ID="lblOrderView4" runat="server" Text=" "></asp:Label>
                                <br />
                                <asp:Label ID="lblOrderView5" runat="server" Text=" "></asp:Label>
                                <br />
                                <asp:Label ID="lblOrderView6" runat="server" Text=" "></asp:Label>
                            </div>

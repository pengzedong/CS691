...
<body>
    <form id="form1" runat="server">
      ...
      <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT StoreID, OrderFood,OrderTime,Waiter  FROM [OrderHistory] where status= 1 and OrderTime >= DATEADD(DAY, DATEDIFF(DAY, 0, GETDATE()) / 7 * 7, 0) AND  OrderTime<= DATEADD(DAY, DATEDIFF(DAY, -1, GETDATE()), 0) order by Waiter"></asp:SqlDataSource>
                </div>
